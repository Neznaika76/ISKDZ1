...
public class Task3 {
    ...
    public static int[] divArrays(int[] firstArray, int[] secondArray) {
        if (firstArray == null || secondArray == null) throw new RuntimeException("Отсутствуют массивы!");
        if(firstArray.length != secondArray.length) throw new RuntimeException("Разные длины массива!");
